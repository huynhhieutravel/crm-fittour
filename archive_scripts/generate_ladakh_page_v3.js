...
const referenceLinks = [
    {
        ...
        desc: "Câu chuyện chân thực của KOL nổi tiếng từng đồng hành cùng FIT Tour",
    ...
    },
    {
        ...
        desc: "Ca sĩ Phương Thanh cạo đầu tại tu viện Hemis & đồng hành cùng FIT Tour",
    ...
    },
    {
        ...
        desc: "Góc nhìn truyền cảm hứng: Sức khỏe tốt là đủ chinh phục mọi giới hạn",
    ...
    },
    {
        ...
        desc: "Tổng hợp trải nghiệm và cảm nhận thực tế từ các đoàn khách",
    ...
    },
    {
        ...
        icon: "Bike", // will use Map or Navigation as fallback if Bike not imported
        color: "#059669"
    },
    {
        title: "Cẩm Nang Du Lịch Ladakh",
        desc: "Đọc trước để hiểu tổng quan thông tin văn hóa, sức khỏe, thời tiết",
    ...
    },
    {
        ...
        desc: "Khẳng định uy tín và năng lực tổ chức tour của FIT Tour",
    ...
    },
    {
        ...
        desc: "Hình ảnh team dày dặn kinh nghiệm dẫn tour Himalaya",
    ...
    },
    {
        ...
        desc: "Gửi ngay cho khách để xem các lịch trình và ngày khởi hành",
    ...
    },
    {
        ...
        desc: "Hành trình truyền thống khám phá Leh, Nubra, Pangong",
    ...
    },
    {
        ...
        desc: "Cung đường nâng cao dành cho người đam mê mạo hiểm & độc lạ",
        url: "https://fittour.vn/tour/tour-kashmir-zanskar",
        icon: "Mountain",
        color: "#0f766e"
    },
    {
        title: "Thư Viện Hình Ảnh (Gallery)",
        desc: "Sưu tầm lại những hình ảnh đẹp nhất của FIT Tour tại Ladakh",
...
import { Briefcase, HeartPulse, CloudSun, BookKey as Passport, Search, Copy, CheckCircle2, ChevronDown, Hash, PhoneCall, Sparkles, MessageSquare, Info, Zap, ChevronRight, Star, Heart, Music, BookOpen, Navigation, Library, Award, Users, List, Map, Mountain, Image as ImageIcon, ExternalLink } from 'lucide-react';

const groupedFaqs = \${JSON.stringify(groupedFaqs, null, 4)};
const referenceLinks = \${JSON.stringify(referenceLinks, null, 4)};
...
const LadakhConsultingPage = () => {
    ...
    const getIcon = (iconName) => {
        switch(iconName) {
            ...
            case "Bike": return <Navigation size={20} />;
        ...
        <div style={{ display: 'flex', minHeight: '100vh', background: '#f8fafc', fontFamily: '"Inter", "Segoe UI", sans-serif', color: '#0f172a' }}>
            ...
            <div style={{ 
                ...
                <div style={{ padding: '0 12px', display: 'flex', flexDirection: 'column', gap: '8px' }}>
                    ...
                    <div style={{ marginBottom: '12px' }}>
                        ...
                        <button
                            onClick={() => scrollTo('references-section')}
                            style={{
                                width: '100%', padding: '8px 12px', borderRadius: '8px', border: 'none', background: 'transparent',
                                color: '#475569', fontWeight: '500', fontSize: '0.9rem', textAlign: 'left', cursor: 'pointer',
                                display: 'flex', alignItems: 'center', gap: '10px', transition: 'all 0.2s'
                            }}
                            onMouseOver={(e) => { e.currentTarget.style.background = '#f1f5f9' }}
                            onMouseOut={(e) => { e.currentTarget.style.background = 'transparent' }}
                        >
                            <div style={{ opacity: 0.4 }}><Library size={14} /></div>
                            <span style={{ flex: 1 }}>Links tham khảo</span>
                        </button>
                    </div>
            ...
            <div style={{ flex: 1, padding: '40px 60px', maxWidth: '1000px', margin: '0 auto' }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '60px' }}>
                                ...
                                {filteredLinks.map((link, idx) => (
                                    ...
                                    >
                                        <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                                            ...
                                            <h3 style={{ fontSize: '1.05rem', fontWeight: '700', color: '#1e293b', margin: 0, flex: 1, lineHeight: '1.4' }}>
                                                {link.title}
                                            </h3>
                                        </div>
                                        ...
                                        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginTop: 'auto', paddingTop: '8px' }}>
                                            <span style={{ fontSize: '0.8rem', color: '#0ea5e9', fontWeight: '600', display: 'flex', alignItems: 'center', gap: '4px' }}>
                                                Mở xem <ExternalLink size={12} />
                                            </span>
                                            <button 
                                                onClick={(e) => handleCopyLink(e, link.url)}
                                                style={{
                                                    background: copiedLink === link.url ? '#10b981' : '#f1f5f9',
                                                    color: copiedLink === link.url ? '#fff' : '#64748b',
                                            ...
                                            >
                                                ...
                                                {copiedLink === link.url ? 'Đã copy' : 'Copy link'}
                                            </button>
                                        </div>
                                    </a>
                                ))}
                    ...
                    {filteredFaqs.length === 0 && filteredLinks.length === 0 && (
...
fs.writeFileSync('client/src/pages/LadakhConsultingPage.jsx', jsxContent);
console.log('Successfully added reference links section with beautiful grid layout.');
