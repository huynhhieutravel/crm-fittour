                ...
                <div style={{ flex: 1, overflowY: 'auto', padding: '2rem' }}>
                    {activeTab === 'general' && (
                        <div>
                            <div className="card" style={{ background: 'white', padding: '1.5rem', borderRadius: '8px', border: '1px solid #e2e8f0', marginBottom: '1.5rem' }}>
                                ...
                                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' }}>
                                    ...
                                    <div className="form-group">
                                        ...
                                        <input type="text" className="form-control" value={formData.market} onChange={e => setFormData({...formData, market: e.target.value})} disabled={isViewOnly} placeholder="Nội địa, Inbound, Hàn Quốc..." />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="card" style={{ background: 'white', padding: '1.5rem', borderRadius: '8px', border: '1px solid #e2e8f0', marginBottom: '1.5rem' }}>
                                <h3 style={{ marginTop: 0, marginBottom: '1.5rem', fontSize: '1.1rem', display: 'flex', alignItems: 'center', gap: '8px' }}>
                                    <CreditCard size={18} color="#10b981" /> Tài chính & Kế toán
                                </h3>
                                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' }}>
                                    <div className="form-group">
                                        <label>Tên tài khoản (Thụ hưởng)</label>
                                        <input type="text" className="form-control" value={formData.bank_account_name} onChange={e => setFormData({...formData, bank_account_name: e.target.value})} disabled={isViewOnly} />
                                    </div>
                                    <div className="form-group">
                                        <label>Số tài khoản</label>
                                        <input type="text" className="form-control" value={formData.bank_account_number} onChange={e => setFormData({...formData, bank_account_number: e.target.value})} disabled={isViewOnly} />
                                    </div>
                                    <div className="form-group">
                                        <label>Ngân hàng & Chi nhánh</label>
                                        <input type="text" className="form-control" value={formData.bank_name} onChange={e => setFormData({...formData, bank_name: e.target.value})} disabled={isViewOnly} />
                                    </div>
                                    <div className="form-group">
                                        <label>Mã số thuế (Hóa đơn xuất)</label>
                                        <input type="text" className="form-control" value={formData.tax_id} onChange={e => setFormData({...formData, tax_id: e.target.value})} disabled={isViewOnly} />
                                    </div>
                                </div>
                            </div>
