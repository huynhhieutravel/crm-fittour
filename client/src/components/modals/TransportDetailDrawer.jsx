...
export default function TransportDetailDrawer({ transport, onClose, refreshList, currentUser, addToast }) {
    ...
    const handleSaveGlobal = async () => {
        try {
            ...
            if (transport?.id) {
                ...
                await axios.post('/api/transports', payload, { headers: { Authorization: `Bearer ${token}` } });
