...
const regexToReplace = /\{\/\* ====== Reference Links Section ====== \*\/\}[\s\S]*?\{\/\* ====== FAQs Section ====== \*\/\}/;

code = code.replace(regexToReplace, `{/* ====== Reference Links Section ====== */}
                    ...
                    {filteredTourLinks.length > 0 && (
                        <div id="tours-section" style={{ display: 'flex', flexDirection: 'column', gap: '24px', scrollMarginTop: '40px' }}>
                            <div style={{ display: 'flex', alignItems: 'center', gap: '12px', paddingBottom: '8px' }}>
...
console.log('Ladakh layout image preview restored, but keeping 2 sections!');
