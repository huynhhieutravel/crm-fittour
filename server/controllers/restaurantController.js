...
exports.createRestaurant = async (req, res) => {
    ...
    try {
        ...
        const result = await client.query(
            ...
            [finalCode, name, tax_id, phone, email, country, province, address, notes, restaurant_class, website, cuisine_type, bank_account_name, bank_account_number, bank_name, market, rating || 0, drive_link || null, req.user.id]
        );
    ...
    if (req.body && req.body.file_url) {
        try {
            ...
            const result = await db.query(
                ...
                [restaurant_id, file_url, file_name, file_type, file_size]
            );
