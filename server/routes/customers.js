...
router.post('/:id/link-app', authenticateToken, permCheck('customers', 'edit'), customerController.linkApp);
router.delete('/:id/link-app', authenticateToken, permCheck('customers', 'edit'), customerController.unlinkApp);
